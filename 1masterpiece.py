...
def run2(color = 1):
    ...
    def movetosoundengineerdestination():
        accDecGems(1.65,30,350,0.3,0.3)
    resetleftmediummotor()
    movetosoundengineerdestination()
...
def run4():
    ...
    # Rotate right slightly to position the stage manager on the destination
    gyrospinturn(12, 150)
    ...
    # Reset the right robot arm to its reset position
